...
<template>
 ...
 <!--     <span class="cui-address-picker-action cui-address-picker-cancel" @click="close"></span>
      <span class="cui-address-picker-action cui-address-picker-confirm" @click="confirm"></span>
-->
